...
const Home = () => {
  return (
    <section className="bg-[#EEF2FF] min-h-screen flex flex-col items-center justify-center px-6 md:px-10 mt-10">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-16 items-center md:flex-row flex flex-col">
        ...
        <motion.div 
          ...
          viewport={{ once: false, amount: 0.2 }} 
          className="space-y-10 md:space-y-6 text-left justify-center order-2 md:order-1"
        >
