...
const Main = () => {
  return (
    <div className="container flex flex-col md:flex-row justify-center items-center gap-10 md:max-w-6xl  w-full  ">
      {/* Image Section */}
      <motion.div
      ...
      >
        <motion.img
          src={PP2}
          alt="Profile"
          className="rounded-lg w-full max-w-[18rem] ml-5 md:max-w-[20rem] object-cover h-auto mt-14 md:mt-0"
          whileInView={{ scale: 1 }}
          initial={{ scale: 0.8 }}
